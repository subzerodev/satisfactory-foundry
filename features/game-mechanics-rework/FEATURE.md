...
|---|---|---|---|
| P0 — data foundations | Parse the tier table from mSpeed÷2 / mFlowLimit×60 (dedupe + sort, derivation test); TRAIN_LOCKOUT_SECONDS 27.08→27 cited to mTimeToCompleteLoad | pending | READY — independent of the topology model |
